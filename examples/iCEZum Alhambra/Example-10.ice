{
  ...
  "design": {
    ...
    "graph": {
      "blocks": [
        ...
        {
          "id": "f8908d46-0978-4817-94c8-6702a1f935ee",
          "type": "basic.input",
          "data": {
            "name": "reset",
            "pins": [
        ...
        {
          "id": "488ce449-9797-4a50-9ad7-c14d29b24fe0",
          "type": "basic.output",
          "data": {
            "name": "LED",
            "pins": [
        ...
        {
          "id": "5230162c-9967-457b-ab42-4b1b06ad079b",
          "type": "basic.constant",
          "data": {
            "name": "FDivider",
            "value": "82",
        ...
        },
        {
          ...
          "type": "basic.info",
          "data": {
            "info": "<b>Ejemplo 10 - Probar el marcador de dos dígitos para el juego.</b>\n<p>En este ejemplo se pone a prueba el marcador del juego.</br>\nSe genera mediante dos bloques dinámicos superpuestos de tipo <i>(<b>PxsCounter</b>)</i> que crean un contador de dos\ndígitos.</br>\nPara generar este contador de dos dígitos se encadenan dinámicamente, mediante el <i>carry</i>, dos\nbloques de tipo <i>(<b>PxsNumber</b>)</i> que, a su vez, está formado por código dinámico <i>(<b>\"DynNumber.v\"</b>)</i> y\nel bloque estático <i>(<b>PxsDigit</b>)</i>. Para ver esta estructura de bloques puedes hacer una doble pulsación en\ncada bloque y bajar en la construcción del diseño.</br>\nPara la prueba se realiza un incremento automático de ambos marcadores (desfasados un ciclo de reloj) con un <i>\"preescaler\"</i>\nde la colección por defecto.</p>",
            "readonly": true
          },
          "position": {
            "x": 48,
        ...
        {
          "id": "fcc805ff-77a8-4cc4-9cd0-7b85dc001952",
          "type": "531038e8a78b071d19f257143f37cb8c3c558906",
          "position": {
            "x": 288,
            "y": 216
          },
        ...
        {
          "id": "bed079c6-eca3-479f-9585-4870146b61ed",
        ...
        {
          "id": "69658266-03e8-4389-a1aa-a416202d9f8f",
        ...
        {
          "id": "eae66ebe-1f8a-469c-a48b-5219102a6a8e",
      ...
      "wires": [
        ...
        {
          "source": {
            "block": "eae66ebe-1f8a-469c-a48b-5219102a6a8e",
        ...
        },
        {
          ...
          "target": {
            "block": "fcc805ff-77a8-4cc4-9cd0-7b85dc001952",
            "port": "2afa8c85-b883-4dd5-821b-0097ab259c01"
          },
          "vertices": [
            {
              "x": 104,
        ...
        },
        {
          ...
          "target": {
            "block": "69658266-03e8-4389-a1aa-a416202d9f8f",
        ...
        {
          "source": {
            "block": "f8908d46-0978-4817-94c8-6702a1f935ee",
            "port": "out"
          },
          "target": {
            "block": "69658266-03e8-4389-a1aa-a416202d9f8f",
        ...
        },
        {
          ...
          "target": {
            "block": "488ce449-9797-4a50-9ad7-c14d29b24fe0",
            "port": "in"
          }
        },
        {
        ...
        },
        {
          ...
          "target": {
            "block": "bed079c6-eca3-479f-9585-4870146b61ed",
        ...
        {
          "source": {
            "block": "5230162c-9967-457b-ab42-4b1b06ad079b",
            "port": "constant-out"
          },
          "target": {
            "block": "eae66ebe-1f8a-469c-a48b-5219102a6a8e",
  ...
  "dependencies": {
    ...
    "531038e8a78b071d19f257143f37cb8c3c558906": {
      "package": {
        "name": "PxsVGAEndframe",
        "version": "1.0",
      ...
      "design": {
        "graph": {
          "blocks": [
            {
              "id": "2afa8c85-b883-4dd5-821b-0097ab259c01",
              "type": "basic.input",
              "data": {
                "name": "px_clk",
                "clock": false
          ...
          "wires": [
            ...
            {
              "source": {
                "block": "2afa8c85-b883-4dd5-821b-0097ab259c01",
                "port": "out"
              },
              "target": {
                "block": "96f9c582-aa38-448f-867b-924e5f1a9fbc",
