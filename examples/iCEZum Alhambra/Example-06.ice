  ...
  "design": {
    ...
    "graph": {
      "blocks": [
        ...
        {
          "id": "a1c809e7-63fa-4711-bb85-f4b3737f52b1",
          "type": "basic.constant",
          "data": {
            "name": "FDivider",
            "value": "83",
        ...
        },
        {
          ...
          "type": "basic.info",
          "data": {
            "info": "<b>Ejemplo 06 - Poner a prueba el comportamiento de ambos jugadores.</b>\n<p>En este ejemplo se demuestra como superponer dos jugadores y crear un nuevo bloque <i>(<b>PxsVerticalPlayers</b>)</i> a\npartir de un bloque simple <i>(<b>PxsPlayer</b>)</i>. Para el ejemplo se actualiza la posición del jugador y se utiliza una\ndinámica simple mediante un bloque de código, un contador y una preescala del reloj del sistema.<p>",
            "readonly": true
          },
          "position": {
            "x": 296,
        ...
        {
          "id": "cd41995c-b941-4278-aca1-09813afe1bf2",
        ...
        {
          "id": "3020f51e-5755-4857-9e5f-fb31b76fa2fb",
        ...
        },
        {
          ...
          "type": "basic.code",
          "data": {
            "code": "reg [9:0] contador1 = 0;\nreg [9:0] contador2 = reset;\n\nassign pos_ply1 = contador1;\nassign pos_ply2 = contador2;\n\nalways @(posedge dyn_clk)\nbegin\n    if (contador1 == reset)\n        contador1 <= 0;\n    else\n        contador1 <= contador1 + 1;\n        \n    if (contador2 == 0)\n        contador2 <= reset;\n    else\n        contador2 <= contador2 - 1;\nend\n    ",
            "params": [
              {
                "name": "reset"
              }
        ...
        {
          "id": "702220b2-de41-442f-9c49-e651428a9ae6",
        ...
        {
          "id": "09611b6e-07e4-4e87-b3c0-0c17ca5cfc4c",
          "type": "basic.info",
          "data": {
            "info": "<b>PxsVerticalPlayers</b>",
            "readonly": true
          },
          "position": {
            "x": 864,
      ...
      "wires": [
        ...
        {
          "source": {
            "block": "702220b2-de41-442f-9c49-e651428a9ae6",
            "port": "e84dbc94-005f-4010-aaa3-62116805de5a"
          },
          "target": {
            "block": "cd41995c-b941-4278-aca1-09813afe1bf2",
        ...
        },
        {
          ...
          "target": {
            "block": "3020f51e-5755-4857-9e5f-fb31b76fa2fb",
        ...
        {
          "source": {
            "block": "a1c809e7-63fa-4711-bb85-f4b3737f52b1",
            "port": "constant-out"
          },
          "target": {
            "block": "702220b2-de41-442f-9c49-e651428a9ae6",
