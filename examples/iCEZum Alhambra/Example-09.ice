  ...
  "design": {
    ...
    "graph": {
      "blocks": [
        ...
        {
          "id": "40474eb3-4d4f-4c27-94cd-ae291d2dd946",
          "type": "basic.constant",
          "data": {
            "name": "N",
            "value": "18",
        ...
        {
          "id": "0a251d71-1952-4d2a-8e5c-9eca3302ab48",
          "type": "basic.constant",
          "data": {
            "name": "FDivider",
            "value": "83",
        ...
        {
          "id": "234f1bcf-3385-4cc9-93f0-70a9a7428afb",
          "type": "basic.constant",
          "data": {
            "name": "width_screen",
            "value": "640",
        ...
        {
          "id": "9de19106-ae95-4635-8276-f7c3ae1cbe77",
          "type": "basic.constant",
          "data": {
            "name": "height_screen",
            "value": "480",
        ...
        },
        {
          ...
          "type": "basic.info",
          "data": {
            "info": "<b>Ejemplo 09 - Poner a prueba el comportamiento de la pelota.</b>\n<p>En este ejemplo se pone a prueba una dinámica básica de rebote para la pelota del juego.</p> \n",
            "readonly": true
          },
          "position": {
            "x": 232,
        ...
        {
          "id": "934a553a-5d70-49b1-b000-a0c61b6d4da5",
        ...
        {
          "id": "7cf1d91f-7339-4d71-8398-4769a83a9e50",
        ...
        {
          "id": "640169bb-fd42-4826-905a-8a695cbdb5ed",
          "type": "basic.code",
          "data": {
            "code": "parameter size_ball = 10;\n\nreg [9:0] x_ball = 10;\nreg [9:0] y_ball = 10;\nreg dx = 1'b0;\nreg dy = 1'b0;\n\nassign pos_x = x_ball;\nassign pos_y = y_ball;\n\nalways @(posedge dyn_clk)\nbegin\n    // Bouncing...\n    if ((x_ball == 0) || (x_ball == width_screen-size_ball))\n        dx = ~dx;\n    if ((y_ball == 0) || (y_ball == height_screen-size_ball))\n        dy = ~dy;\n\n    // Update x position.\n    if (dx)\n        x_ball <= x_ball - 1;\n    else\n        x_ball <= x_ball + 1; \n\n    // Update y position.\n    if (dy)\n        y_ball <= y_ball - 1;\n    else\n        y_ball <= y_ball + 1; \nend\n",
            "params": [
              {
                "name": "width_screen"
              },
        ...
        {
          "id": "a04d51ea-9e84-4548-bba4-5482490c810b",
      ...
      "wires": [
        ...
        {
          "source": {
            "block": "a04d51ea-9e84-4548-bba4-5482490c810b",
        ...
        {
          "source": {
            "block": "934a553a-5d70-49b1-b000-a0c61b6d4da5",
        ...
        {
          "source": {
            "block": "40474eb3-4d4f-4c27-94cd-ae291d2dd946",
            "port": "constant-out"
          },
          "target": {
            "block": "7cf1d91f-7339-4d71-8398-4769a83a9e50",
        ...
        },
        {
          ...
          "target": {
            "block": "640169bb-fd42-4826-905a-8a695cbdb5ed",
            "port": "dyn_clk"
          },
          "vertices": []
        },
        ...
        {
          "source": {
            "block": "9de19106-ae95-4635-8276-f7c3ae1cbe77",
            "port": "constant-out"
          },
          "target": {
            "block": "640169bb-fd42-4826-905a-8a695cbdb5ed",
        ...
        {
          "source": {
            "block": "234f1bcf-3385-4cc9-93f0-70a9a7428afb",
            "port": "constant-out"
          },
          "target": {
            "block": "640169bb-fd42-4826-905a-8a695cbdb5ed",
        ...
        {
          "source": {
            "block": "0a251d71-1952-4d2a-8e5c-9eca3302ab48",
            "port": "constant-out"
          },
          "target": {
            "block": "a04d51ea-9e84-4548-bba4-5482490c810b",
