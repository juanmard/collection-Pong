{
  ...
  "design": {
    ...
    "graph": {
      "blocks": [
        ...
        {
          "id": "e01cb2fd-f609-4cc8-b661-21863e3a0126",
          "type": "basic.constant",
          "data": {
            "name": "FDivider",
            "value": "83",
        ...
        {
          "id": "7c3d2d95-1b42-4107-80c9-1ac0743d7d26",
          "type": "basic.constant",
          "data": {
            "name": "color",
            "value": "3'b110",
        ...
        },
        {
          ...
          "type": "basic.info",
          "data": {
            "info": "<b>Ejemplo 02 - Prueba de bloques <i>Overlay</i>.</b>\n<p>Con este ejemplo comenzamos las pruebas de los bloques de tipo <i>\"Overlay\"</i>. Estos bloques se usan en conjunción\ncon bloques <i>\"Videogen\"</i> y superponen a este último una imagen en el <i>\"stream RGB\"</i>. Se puede pensar que\nlos bloques <i>\"Overlay\"</i> funcionan a modo de capas. Se pueden superponer las capas que queramos, sabiendo que\nno hay transparencia de pixel y que, por tanto, la última capa será la que prevalezca sobre las demás.</br>\nEn este ejemplo superpondremos un único bloque que representará en pantalla un dígito del marcador\n<i>(<b>PxsDigit</b>)</i>. Este bloque admite una posición \"x\" y otra \"y\" (que representa la posición de la esquina\nsuperior izquierda del dígito en pantalla) y el valor del número a representar, además se puede definir el color del dígito completo\nmediante la constante \"color\".\n</br> Para realizar la prueba emplearemos una asignación directa de los valores desde un bloque de código.</p>",
            "readonly": true
          },
          "position": {
            "x": 176,
        ...
        {
          "id": "9201b421-a052-4231-b143-9cebf14826de",
          "type": "basic.code",
          "data": {
        ...
        {
          "id": "f48a450b-1874-4073-94ab-8c782ee6dd75",
          "type": "2e2ec36c9269241ac28eb740af09d2e938634a32",
          "position": {
            "x": 712,
            "y": 104
          },
        ...
        {
          "id": "e28c7fee-733e-4836-95dc-1af6bae91487",
      ...
      "wires": [
        ...
        {
          "source": {
            "block": "e28c7fee-733e-4836-95dc-1af6bae91487",
        ...
        },
        {
          ...
          "target": {
            "block": "f48a450b-1874-4073-94ab-8c782ee6dd75",
        ...
        {
          "source": {
            "block": "9201b421-a052-4231-b143-9cebf14826de",
            "port": "pos_x"
          },
          "target": {
            "block": "f48a450b-1874-4073-94ab-8c782ee6dd75",
        ...
        {
          "source": {
            "block": "7c3d2d95-1b42-4107-80c9-1ac0743d7d26",
            "port": "constant-out"
          },
          "target": {
            "block": "f48a450b-1874-4073-94ab-8c782ee6dd75",
        ...
        {
          "source": {
            "block": "e01cb2fd-f609-4cc8-b661-21863e3a0126",
            "port": "constant-out"
          },
          "target": {
            "block": "e28c7fee-733e-4836-95dc-1af6bae91487",
  ...
  "dependencies": {
    ...
    "2e2ec36c9269241ac28eb740af09d2e938634a32": {
      "package": {
        "name": "PxsDigit",
        "version": "1.0",
