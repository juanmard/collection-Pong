  ...
  "design": {
    ...
    "graph": {
      "blocks": [
        ...
        {
          "id": "5ac1bb75-8e37-402c-98f0-e018a50d892f",
          "type": "basic.constant",
          "data": {
            "name": "FDivider",
            "value": "83",
        ...
        {
          "id": "52bdf2c1-ca02-4a23-b802-f7e0f118674b",
          "type": "basic.constant",
          "data": {
            "name": "N",
            "value": "18",
        ...
        {
          "id": "c49777cb-6989-4800-8273-1276e70ed8be",
          "type": "basic.constant",
          "data": {
            "name": "reset",
            "value": "480",
        ...
        {
          "id": "ddc302c9-c290-4b9d-8717-0c79346e6b40",
          "type": "basic.constant",
          "data": {
            "name": "type",
            "value": "1'b0",
        ...
        {
          "id": "1810f8da-cae5-495f-b238-0e8552e6c8f4",
          "type": "basic.constant",
          "data": {
            "name": "offset",
            "value": "30",
        ...
        },
        {
          ...
          "type": "basic.info",
          "data": {
            "info": "<b>Ejemplo 05 - Poner a prueba el comportamiento del jugador.</b>\n<p>En este ejemplo se actualiza la posición del jugador mediante un contador y una\npreescala del reloj del sistema.</br>\nSe puede modificar el <b>tipo</b> de jugador y el <b><i>offset</i></b> (separación de los bordes) utilizando\nlos bloques constantes.</br>El jugador debe de moverse automáticamente de izquierda a derecha o de arriba a\nabajo según el tipo definido. Al llegar al valor de <i>reset</i> del bloque de código la posición del\njugador vuelve a cero.</p> \n",
            "readonly": true
          },
          "position": {
            "x": 288,
        ...
        {
          "id": "3f93bae6-2c9b-4391-bb0c-624b0e8ca5f6",
        ...
        {
          "id": "b50a421d-3d1a-475e-82e1-9cfafdce0c8c",
        ...
        {
          "id": "ebf22461-ebae-4e0d-8f63-3604fa73626d",
          "type": "basic.code",
          "data": {
            "code": "reg [9:0] contador;\n\nassign pos = contador;\n\nalways @(posedge dyn_clk)\nbegin\n    contador <= contador + 1;\n    if (contador > reset) contador <= 0;\nend\n    ",
            "params": [
              {
                "name": "reset"
              }
        ...
        {
          "id": "872de656-8d90-4ca3-9d0a-8bf83d829e08",
          "type": "basic.info",
          "data": {
            "info": "<b>PxsPlayer</b>",
            "readonly": true
        ...
        {
          "id": "bb21d98e-c9c9-42dc-beeb-dc3fe97301b5",
      ...
      "wires": [
        ...
        {
          "source": {
            "block": "bb21d98e-c9c9-42dc-beeb-dc3fe97301b5",
        ...
        },
        {
          ...
          "target": {
            "block": "b50a421d-3d1a-475e-82e1-9cfafdce0c8c",
        ...
        {
          "source": {
            "block": "1810f8da-cae5-495f-b238-0e8552e6c8f4",
            "port": "constant-out"
          },
          "target": {
            "block": "b50a421d-3d1a-475e-82e1-9cfafdce0c8c",
        ...
        {
          "source": {
            "block": "ddc302c9-c290-4b9d-8717-0c79346e6b40",
            "port": "constant-out"
          },
          "target": {
            "block": "b50a421d-3d1a-475e-82e1-9cfafdce0c8c",
        ...
        {
          "source": {
            "block": "52bdf2c1-ca02-4a23-b802-f7e0f118674b",
            "port": "constant-out"
          },
          "target": {
            "block": "3f93bae6-2c9b-4391-bb0c-624b0e8ca5f6",
        ...
        {
          "source": {
            "block": "ebf22461-ebae-4e0d-8f63-3604fa73626d",
            "port": "pos"
          },
          "target": {
            "block": "b50a421d-3d1a-475e-82e1-9cfafdce0c8c",
        ...
        {
          "source": {
            "block": "c49777cb-6989-4800-8273-1276e70ed8be",
            "port": "constant-out"
          },
          "target": {
            "block": "ebf22461-ebae-4e0d-8f63-3604fa73626d",
        ...
        {
          "source": {
            "block": "5ac1bb75-8e37-402c-98f0-e018a50d892f",
            "port": "constant-out"
          },
          "target": {
            "block": "bb21d98e-c9c9-42dc-beeb-dc3fe97301b5",
