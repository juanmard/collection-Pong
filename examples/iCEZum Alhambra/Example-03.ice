  ...
  "design": {
    ...
    "graph": {
      "blocks": [
        ...
        {
          "id": "75fc8c1b-50e4-4025-a46a-acb434fb8181",
          "type": "basic.output",
          "data": {
            "name": "LED",
            "pins": [
        ...
        {
          "id": "e7d1c200-97f9-4ffa-a153-1402572b8c4b",
          "type": "basic.input",
          "data": {
            "name": "reset",
            "pins": [
        ...
        {
          "id": "51636247-cbad-45ee-92ac-4d782f22d8a3",
          "type": "basic.constant",
          "data": {
            "name": "N",
            "value": "24",
        ...
        {
          "id": "fcf4186c-fe48-4c02-a314-0173249838ae",
          "type": "basic.constant",
          "data": {
            "name": "FDivider",
            "value": "83",
        ...
        {
          "id": "6c3dca9e-4820-4d0f-90d8-4dc2ace2c662",
          "type": "basic.constant",
          "data": {
            "name": "color",
            "value": "3'b010",
        ...
        },
        {
          ...
          "type": "basic.info",
          "data": {
            "info": "<b>Ejemplo 03 - Prueba con un <i>Overlay</i> dinámico.</b>\n<p>En este ejemplo se muestra como utilizar un bloque <i>Overlay</i> con dinámica <i>(<b>PxsNumber</b>)</i> basándose en uno \nestático <i>(<b>PxsDigit</b>)</i>.</br>\nPara que los cambios que se produzcan con la dinámica no interfieran en la visualización, ésta se actualizará\núnicamente cuando se termine de visualizar un <i>\"frame\"</i> en el monitor VGA, para ello se utilizará el bloque\n<i><b>PxsVGAEndframe</b></i> que comprueba continuamente el <i>stream VGA</i> y genera la señal correspondiente\nal final de cada cuadro. Esta señal será la encargada de establecer el reloj con el que funcionará la dinámica del bloque.</br>\nEn este ejemplo la posición se fija con un bloque de código y el número se incrementa automáticamente mediantecon un preescaler\nde la colección básica. El reset se produce mediante un botón exterior y el <i>\"carry\"</i> se muestra mediante la activación de\nun LED.</p>",
            "readonly": true
          },
          "position": {
            "x": 160,
        ...
        {
          "id": "db5bd105-0412-4325-aecc-442616e6aa78",
        ...
        {
          "id": "bdfb0b3e-6f03-4427-b06d-230d92acf3a2",
        ...
        {
          "id": "154a88f1-0870-4eaf-896c-f81460ae71ff",
        ...
        {
          "id": "4a589617-822b-4fd4-ae23-e2410e02cf4c",
          "type": "basic.code",
          "data": {
        ...
        {
          "id": "9ee9ac82-7d2c-4301-a593-7e887dd93b4d",
          "type": "basic.info",
          "data": {
            "info": "<b>PxsVGAEndframe</b>",
            "readonly": true
          },
          "position": {
            "x": 408,
        ...
        {
          "id": "48dd44ee-9b98-4fa8-bbdf-30c459912c85",
        ...
        {
          "id": "0dcef621-3740-482e-a5fe-623c45f3ad86",
      ...
      "wires": [
        ...
        {
          "source": {
            "block": "0dcef621-3740-482e-a5fe-623c45f3ad86",
            "port": "6e4ac81b-0abc-4441-a529-d2cb74e0a28c"
          },
          "target": {
            "block": "48dd44ee-9b98-4fa8-bbdf-30c459912c85",
        ...
        {
          "source": {
            "block": "bdfb0b3e-6f03-4427-b06d-230d92acf3a2",
        ...
        },
        {
          ...
          "target": {
            "block": "db5bd105-0412-4325-aecc-442616e6aa78",
        ...
        {
          "source": {
            "block": "51636247-cbad-45ee-92ac-4d782f22d8a3",
            "port": "constant-out"
          },
          "target": {
            "block": "154a88f1-0870-4eaf-896c-f81460ae71ff",
            "port": "de2d8a2d-7908-48a2-9e35-7763a45886e4"
          }
        },
        {
          "source": {
            "block": "4a589617-822b-4fd4-ae23-e2410e02cf4c",
            "port": "pos_x"
          },
          "target": {
            "block": "bdfb0b3e-6f03-4427-b06d-230d92acf3a2",
        ...
        {
          "source": {
            "block": "e7d1c200-97f9-4ffa-a153-1402572b8c4b",
            "port": "out"
          },
          "target": {
            "block": "bdfb0b3e-6f03-4427-b06d-230d92acf3a2",
        ...
        {
          "source": {
            "block": "6c3dca9e-4820-4d0f-90d8-4dc2ace2c662",
            "port": "constant-out"
          },
          "target": {
            "block": "bdfb0b3e-6f03-4427-b06d-230d92acf3a2",
        ...
        },
        {
          ...
          "target": {
            "block": "75fc8c1b-50e4-4025-a46a-acb434fb8181",
            "port": "in"
          },
          "vertices": [
            {
        ...
        {
          "source": {
            "block": "fcf4186c-fe48-4c02-a314-0173249838ae",
            "port": "constant-out"
          },
          "target": {
            "block": "0dcef621-3740-482e-a5fe-623c45f3ad86",
